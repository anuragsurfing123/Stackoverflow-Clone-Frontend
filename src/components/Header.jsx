    ...
    <Navbar bg="light" expand="lg" className='fixed-top'>
      <Container fluid >
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            <Nav.Link className = "text-dark" href="#action1">About</Nav.Link>
            <Nav.Link className = "text-dark"  href="#action2">Product</Nav.Link>
            <Nav.Link className = "text-dark"  href="#action2">Team</Nav.Link>
